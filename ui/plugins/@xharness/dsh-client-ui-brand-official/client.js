	...
	factory: (require) => {
		...
		*/
		function OfficialBrandMark({ size, className }) {
			return (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.FishLogo, {
				size,
				className
			});
		}
		...
		*/
		function OfficialBrandName() {
			return (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.BrandWordmark, { includeMark: false });
		}
		//#endregion
