  ...
  factory: (require) => {
    ...
    function HarnessView({ useSession }) {
      ...
      if (selected === undefined) {
        return h('div', { className: 'xhctx-root' }, h('div', { className: 'xhctx-empty' }, '还没有可用的 Harness 请求快照。'))
      }
      ...
      return h('div', { className: 'xhctx-root xhctx-harness-root' }, [
    ...
    function ContextView({ useSession }) {
      ...
      return h('div', { className: 'xhctx-root' }, [
    ...
    const CSS = `
.xhctx-root{height:100%;overflow:auto;background:#f8fafc;color:#172033;padding:14px 18px 60px;box-sizing:border-box}
...
@media(max-width:760px){.xhctx-root{padding:10px 10px 50px}.xhctx-toolbar{align-items:stretch}.xhctx-select,.xhctx-search{width:100%}.xhctx-diff,.xhctx-harness-columns{grid-template-columns:1fr}.xhctx-harness-toolbar{flex-wrap:wrap}.xhctx-harness-hint{width:100%;margin:0}.xhctx-pipeline{grid-template-columns:1fr 1fr;gap:10px}.xhctx-pipeline-step:after{display:none}.xhctx-registry{grid-template-columns:1fr}.xhctx-tool-head{align-items:stretch;flex-direction:column}.xhctx-tool-search{width:100%}}
