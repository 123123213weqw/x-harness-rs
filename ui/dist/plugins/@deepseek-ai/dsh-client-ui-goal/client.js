					...
					children: [
						...
						(0, react_jsx_runtime.jsxs)("div", {
							...
							children: [react_jsx_runtime.jsx(XhGoalControls,{projection,onComplete,onResume,onBudget,runAction,pending},goal.id),
								goal.phase === "active" && projection?.execution?.state!=="disabled" && (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Tooltip, {
		...
		*/
		function apply(ctx) {
			...
			ctx.slots.inject("conversation.input.dock", () => ctx.slots.register({
				...
				order: 10,
				locale: NS,
				inject: (sessionId) => ({goalSessionId:sessionId,onCreate:async objective=>await ctx.remote.goals.create(sessionId,{objective}),
