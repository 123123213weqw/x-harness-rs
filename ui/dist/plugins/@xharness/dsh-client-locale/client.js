window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:deepseek-harness/packages/client/locale/src/client/LanguageRow.module.css.mjs
		const css = "._6PhFsW_row{border-bottom:1px solid var(--dsw-alias-border-l2);align-items:center;gap:8px;padding:16px 0;display:flex}._6PhFsW_rowText{flex-direction:column;flex:1;gap:4px;min-width:0;padding-right:48px;display:flex}._6PhFsW_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}._6PhFsW_selector{background:var(--dsw-alias-bg-module-platform);height:36px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:18px;align-items:center;gap:12px;padding:0 14px;font-size:14px;line-height:22px;display:inline-flex}._6PhFsW_selector:hover{background:var(--dsw-alias-interactive-bg-hover)}._6PhFsW_chevron{flex:none}";
		const tagId = "@xharness/dsh-client-locale/LanguageRow.module.css";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "@xharness/dsh-client-locale";
			tag.dataset.pluginCss = tagId;
			tag.textContent = css;
			document.head.appendChild(tag);
		}
		var LanguageRow_module_css_default = {
			"chevron": "_6PhFsW_chevron",
			"row": "_6PhFsW_row",
			"rowText": "_6PhFsW_rowText",
			"selector": "_6PhFsW_selector",
			"title": "_6PhFsW_title"
		};
		//#endregion
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [(0, react_jsx_runtime.jsx)("div", {
					...
					anchor: (0, react_jsx_runtime.jsxs)("button", {
						...
						children: [activeLabel, (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconChevronDownOutline14, { className: LanguageRow_module_css_default.chevron })]
					})
				})]
			});
		}
