window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const CUBES = [
			{
				...
				Icon: _xharness_dsh_client_ui_primitives.IconLightOutline16
			},
			{
				id: "dark",
				labelKey: "appearance.dark",
				Icon: _xharness_dsh_client_ui_primitives.IconDarkOutline16
			},
			{
				id: "system",
				labelKey: "appearance.system",
				Icon: _xharness_dsh_client_ui_primitives.IconFollowsystemOutline16
			}
		];
		/**
		...
		*/
		...
		//#endregion
		//#region \0dsh-inline-css:deepseek-harness/packages/client/ui-theme/src/styles/base.css.mjs
		...
		//#endregion
		//#region \0dsh-inline-css:deepseek-harness/packages/client/ui-theme/src/styles/design-platform.css.mjs
		...
		//#endregion
		//#region \0dsh-inline-css:deepseek-harness/packages/client/ui-theme/src/styles/scrollbar.css.mjs
		...
		//#endregion
		//#region \0dsh-inline-css:deepseek-harness/packages/client/ui-theme/src/styles/gradient-shadow-text.css.mjs
		...
		//#endregion
		//#region \0dsh-inline-css:deepseek-harness/packages/client/ui-theme/src/styles/shiki.css.mjs
