	...
	factory: (require) => {
		...
		*/
		var PopupSelectController = class {
			...
			state = (0, _xharness_dsh_client_runtime_client.createSnapshotStore)(CLOSED);
			binding = null;
			/**
		...
		*/
		...
		var CommandUiRuntime = class extends _xharness_cordis.Service {
			static inject = [
				"inputTriggers",
				"sessions",
				"remote",
		...
		*/
		function PopupSelectView({ popup, t }) {
			...
			const maxHeight = (0, _xharness_dsh_client_ui_primitives.useAnchoredMaxHeight)(cardRef, MAX_HEIGHT, state);
						...
						children: rows.map((option, index) => (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								option.active === true && (0, react_jsx_runtime.jsx)("span", {
									...
									children: (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconCheckOutline16, {})
								})
							]
						}, option.id))
					})
				]
			}), confirmation !== void 0 && (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.RiskConfirmation, {
				open: true,
