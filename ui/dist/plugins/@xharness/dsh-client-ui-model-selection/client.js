window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		var ModelDirectoryResolver = class extends _xharness_cordis.Service {
			static inject = [
				"connection",
				"sessions",
				"remote"
						...
						children: [
							pane === "root" && (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [(0, react_jsx_runtime.jsxs)("button", {
								...
								children: [
									...
									(0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconChevronRightOutline14, { className: ModelSelect_module_css_default.cellChevron })
								]
              ...
              pane === "context" && react.createElement(XHarnessContextPane, {locked, directory, load: reload, select, back: () => setPane("root"), saved: () => close(true)}),
											...
											children: [(0, react_jsx_runtime.jsx)("div", {
												...
												return (0, react_jsx_runtime.jsxs)("button", {
													...
													children: [(0, react_jsx_runtime.jsxs)("span", {
														...
														children: selected ? (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconCheckOutline16, {}) : null
													})]
												}, model.id);
											})]
										}, group.id);
							...
							pane === "effort" && (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [state.error !== null && lastActionRef.current === "load" && (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [(0, react_jsx_runtime.jsxs)("span", {
									...
									className: ModelSelect_module_css_default.check,
									children: effectiveEffort === level.effort ? (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconCheckOutline16, {}) : null
								})]
							}, level.key))] })
						]
					}),
