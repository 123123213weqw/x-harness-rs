	...
	factory: (require) => {
		...
		function RunHeader({ children, count, name, onToggle, open, status, t }) {
			return (0, react_jsx_runtime.jsx)(StatusDisclosure, {
				icon: (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconChevronRightOutline14, {}),
				...
				collapsedContent: (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
					...
					(0, react_jsx_runtime.jsxs)("span", {
						...
						"data-status": status,
						children: [(0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.StateDot, { state: dotState(status) }), (0, react_jsx_runtime.jsx)("span", { children: t(STATUS_KEYS[status]) })]
					})
				] }),
				children
			});
		...
		function MemberRow({ member, navigable, openSession, t }) {
			...
			const content = (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
				(0, react_jsx_runtime.jsx)("span", {
					...
					children: (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.StateDot, { state: dotState(member.status) })
				}),
				(0, react_jsx_runtime.jsx)("span", {
		...
		function WorkflowRunPanel({ node, sessionId, useSessions, openSession, t }) {
			...
			const navigable = useSessions((sessions) => navigableMembers(sessions, node.data.phases, sessionId), _xharness_dsh_client_runtime_client.shallowEqual);
