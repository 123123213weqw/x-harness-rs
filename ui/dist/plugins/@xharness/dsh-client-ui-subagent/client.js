	...
	factory: (require) => {
			...
			return children.map((summary) => (0, react_jsx_runtime.jsx)("div", {
				...
				children: (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						(0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.StateDot, { state: summary.running ? "ongoing" : "done" }),
			...
			return (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
				...
				catalog.state === "error" && (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [(0, react_jsx_runtime.jsx)("span", { children: catalog.error?.message ?? t("load.error") }), (0, react_jsx_runtime.jsxs)("button", {
						...
						children: [(0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconRefreshOutline14, {}), t("retry")]
					})]
				}),
						...
						return (0, react_jsx_runtime.jsx)("div", {
							...
							children: (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									(0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.StateDot, { state: "error" }),
					...
					return (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [(0, react_jsx_runtime.jsxs)("div", {
							...
							children: [knownLeaf ? reserveDisclosure && (0, react_jsx_runtime.jsx)("span", { className: SubagentCatalogAction_module_css_default.disclosureSpace }) : (0, react_jsx_runtime.jsx)("button", {
								...
								children: [
									(0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.StateDot, { state: entry.activity === "running" ? "ongoing" : "done" }),
									(0, react_jsx_runtime.jsxs)("span", {
										className: SubagentCatalogAction_module_css_default.content,
										children: [(0, react_jsx_runtime.jsx)("span", {
											className: SubagentCatalogAction_module_css_default.label,
		...
		*/
		function SubagentCatalogAction({ sessionId, useSessions, openChild, refresh, setCatalogOpen, t }) {
			...
			const descendants = (0, react.useMemo)(() => (0, _xharness_dsh_client_runtime_client.indexSubagentDescendants)(summaries).get(sessionId) ?? NO_DESCENDANTS, [sessionId, summaries]);
				...
				children: [(0, react_jsx_runtime.jsxs)("button", {
					...
					children: [
						(0, react_jsx_runtime.jsx)("span", {
							...
							children: descendants.runningCount > 0 && (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.StateDot, { state: "ongoing" })
						}),
						(0, react_jsx_runtime.jsx)("span", {
							className: SubagentCatalogAction_module_css_default.count,
							children: t(totalCountKey, { count: descendantCount })
						}),
						(0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconChevronDownOutline14, { className: open ? SubagentCatalogAction_module_css_default.triggerOpen : void 0 })
					]
		...
		//#endregion
		//#region \0dsh-css:deepseek-harness/packages/client/ui-subagent/src/client/SubagentReadOnlyComposer.module.css.mjs
		const css = ".ZuKiNG_frame{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);min-height:54px;color:var(--dsw-alias-label-tertiary);border-radius:14px;justify-content:center;align-items:center;gap:8px;margin:0 24px 20px;padding:10px 16px;font-size:13px;line-height:20px;display:flex}.ZuKiNG_frame strong{color:var(--dsw-alias-label-primary);font-weight:510}";
		const tagId = "@xharness/dsh-client-ui-subagent/SubagentReadOnlyComposer.module.css";
		...
		var SubagentReadOnlyComposer_module_css_default = { "frame": "ZuKiNG_frame" };
		//#endregion
