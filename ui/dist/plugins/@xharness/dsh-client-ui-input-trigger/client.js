	...
	factory: (require) => {
		...
		*/
		var InputTriggerController = class {
			...
			menu = (0, _xharness_dsh_client_runtime_client.createSnapshotStore)(MENU_CLOSED);
			/**
			...
			*/
			launcher = (0, _xharness_dsh_client_runtime_client.createSnapshotStore)(null);
			/**
			...
			* mutable answer.
			*/
			lexicon = (0, _xharness_dsh_client_runtime_client.createSnapshotStore)(/* @__PURE__ */ new Map());
		...
		*/
		...
		var InputTriggerService = class extends _xharness_cordis.Service {
		...
		*/
		function MenuView({ menu, onPick, onDismiss, t }) {
			...
			const maxHeight = (0, _xharness_dsh_client_ui_primitives.useAnchoredMaxHeight)(listRef, MAX_HEIGHT, state);
