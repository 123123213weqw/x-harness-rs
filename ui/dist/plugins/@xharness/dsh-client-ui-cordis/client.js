window.__ModuleLoader__.load({
	id: "@xharness/dsh-client-ui-cordis",
	factory: (require) => {
		var module = { exports: {} };
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:deepseek-harness/packages/extensions/ui-cordis/src/client/CordisRunRow.module.css.mjs
		const css$2 = ".KkBbda_card{flex-direction:column;gap:8px;display:flex}.KkBbda_row{align-items:center;min-height:32px;display:flex}.KkBbda_icon{color:var(--dsw-alias-state-business-primary);flex:none;margin-right:8px;display:inline-flex}.KkBbda_title{color:var(--dsw-alias-state-business-primary);flex:none;font-size:14px;font-weight:500;line-height:24px}.KkBbda_separator{background:var(--dsw-alias-state-business-primary);border-radius:50%;flex:none;width:2px;height:2px;margin:0 8px}.KkBbda_summary,.KkBbda_error{min-width:0;color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;line-height:24px;overflow:hidden}.KkBbda_error{color:var(--dsw-alias-state-error-primary)}.KkBbda_status{color:var(--dsw-alias-label-caption);flex:none;margin-left:8px;font-size:12px;line-height:24px}.KkBbda_card[data-cordis-status=awaiting-approval] .KkBbda_status,.KkBbda_card[data-cordis-status=client-pending] .KkBbda_status{color:var(--dsw-alias-state-warn-label)}.KkBbda_card[data-cordis-status=running] .KkBbda_status{color:var(--dsw-alias-state-success-primary)}.KkBbda_card[data-cordis-status=failed] .KkBbda_status{color:var(--dsw-alias-state-error-primary)}.KkBbda_inspect{width:24px;height:24px;color:var(--dsw-alias-label-tertiary);cursor:pointer;opacity:0;background:0 0;border:none;border-radius:999px;justify-content:center;align-items:center;margin-left:4px;padding:0;display:inline-flex}.KkBbda_card:hover .KkBbda_inspect,.KkBbda_inspect:focus-visible{opacity:1}.KkBbda_inspect:hover{background:var(--dsw-alias-interactive-bg-hover)}.KkBbda_message{background:var(--dsw-alias-button-ghost-active-fill);color:var(--dsw-alias-label-tertiary);border-radius:8px;padding:8px 12px;font-size:12px;line-height:18px}.KkBbda_business{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);border-radius:12px;min-width:0;overflow:hidden}.KkBbda_output{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-markdown-code-block);color:var(--dsw-alias-label-secondary);font:var(--dsw-font-markdown-code-block-small);white-space:pre-wrap;overflow-wrap:anywhere;border-radius:8px;margin:0;padding:10px 12px;overflow:auto}.KkBbda_business .KkBbda_output{border:none;border-radius:0}";
		const tagId$2 = "@xharness/dsh-client-ui-cordis/CordisRunRow.module.css";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId$2) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "@xharness/dsh-client-ui-cordis";
				...
				children: [(0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						(0, react_jsx_runtime.jsx)("span", {
							...
							children: card.state === "error" ? (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.StateDot, { state: "error" }) : card.state === "stopped" ? (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.StateDot, { state: "warning" }) : remove ? (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconTrashOutline16, { size: 14 }) : (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconStopFill16, { size: 14 })
						}),
						(0, react_jsx_runtime.jsx)("span", {
						...
						inspect !== void 0 && (0, react_jsx_runtime.jsx)("button", {
							...
							"aria-label": "Inspect",
							onClick: inspect,
							children: (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconInspectOutline12, {})
						})
					]
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:deepseek-harness/packages/extensions/ui-cordis/src/client/CordisDefineRow.module.css.mjs
		const css$1 = ".tCdZ6q_card{flex-direction:column;display:flex}.tCdZ6q_card .tCdZ6q_title,.tCdZ6q_card .tCdZ6q_chevron{color:var(--dsw-alias-state-business-primary)}.tCdZ6q_title{flex:none;font-size:14px;font-weight:500;line-height:24px}.tCdZ6q_row{gap:0}.tCdZ6q_separator{background:var(--dsw-alias-state-business-primary);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.tCdZ6q_name{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-secondary);flex:none;font-size:14px;line-height:24px;overflow:hidden}.tCdZ6q_purpose{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;margin-left:8px;font-size:13px;line-height:24px;overflow:hidden}.tCdZ6q_errorSummary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-state-error-primary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.tCdZ6q_requestError{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-state-error-primary);flex:none;margin-left:8px;font-size:12px;line-height:24px;overflow:hidden}.tCdZ6q_readout{flex:none;align-items:center;margin-left:8px;display:inline-flex}.tCdZ6q_panelHint{color:var(--dsw-alias-label-caption);margin:4px 0 2px 4px;font-size:11px;line-height:16px}.tCdZ6q_statusLabel{color:var(--dsw-alias-label-caption);font-size:12px;line-height:24px}.tCdZ6q_approvalPrompt{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-secondary);flex:none;margin-left:8px;font-size:12px;line-height:24px;overflow:hidden}.tCdZ6q_notice{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-caption);flex:none;margin-left:8px;font-size:12px;line-height:24px;overflow:hidden}.tCdZ6q_switch{height:22px;padding:0 8px;font-size:12px}.tCdZ6q_card[data-terminal] .tCdZ6q_title,.tCdZ6q_card[data-terminal] .tCdZ6q_name,.tCdZ6q_card[data-terminal] .tCdZ6q_purpose,.tCdZ6q_card[data-terminal] .tCdZ6q_statusLabel{color:var(--dsw-alias-label-caption)}.tCdZ6q_card[data-terminal] .tCdZ6q_separator{background:var(--dsw-alias-label-caption)}.tCdZ6q_bodyWrap{flex-direction:column;display:flex}.tCdZ6q_sourceCard{flex-direction:column;margin:4px 0 4px 4px;display:flex}.tCdZ6q_sourceTabs{border-bottom:1px solid var(--dsw-alias-border-l2);height:32px;display:flex}.tCdZ6q_sourceTab{color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xs-13);background:0 0;border:0;padding:0 10px;position:relative}.tCdZ6q_sourceTab:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.tCdZ6q_sourceTab:disabled{cursor:default;opacity:.4}.tCdZ6q_sourceTabActive{color:var(--dsw-alias-state-business-primary)}.tCdZ6q_sourceTabActive:after{background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:1px 1px 0 0;height:2px;position:absolute;bottom:0;left:10px;right:10px}.tCdZ6q_sourceTab:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.tCdZ6q_sourcePanel{max-height:260px;overflow:auto}.tCdZ6q_sourceCode{margin:0}.tCdZ6q_codeSection{flex-direction:column;max-height:260px;margin:4px 0 4px 4px;display:flex;overflow:auto}.tCdZ6q_sectionLabel{color:var(--dsw-alias-label-caption);text-transform:uppercase;letter-spacing:.04em;flex:none;padding:2px 0;font-size:11px;font-weight:500;line-height:16px}.tCdZ6q_output{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);white-space:pre-wrap;overflow-wrap:anywhere;font:var(--dsw-font-markdown-code-block-small);color:var(--dsw-alias-label-secondary);border-radius:8px;margin:0;padding:8px 10px}.tCdZ6q_output[data-error]{color:var(--dsw-alias-state-error-primary)}.tCdZ6q_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.tCdZ6q_card:hover .tCdZ6q_inspectButton,.tCdZ6q_inspectButton:focus-visible{opacity:1}.tCdZ6q_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.tCdZ6q_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}@media (prefers-reduced-motion:reduce){.tCdZ6q_inspectButton{transition:none}}";
		const tagId$1 = "@xharness/dsh-client-ui-cordis/CordisDefineRow.module.css";
		...
		var CordisDefineRow_module_css_default = {
			"approvalPrompt": "tCdZ6q_approvalPrompt",
			"bodyWrap": "tCdZ6q_bodyWrap",
			"card": "tCdZ6q_card",
			"chevron": "tCdZ6q_chevron",
			"codeSection": "tCdZ6q_codeSection",
			"errorSummary": "tCdZ6q_errorSummary",
			"inspectButton": "tCdZ6q_inspectButton",
			"name": "tCdZ6q_name",
			"notice": "tCdZ6q_notice",
			"output": "tCdZ6q_output",
			"panelHint": "tCdZ6q_panelHint",
			"purpose": "tCdZ6q_purpose",
			"readout": "tCdZ6q_readout",
			"requestError": "tCdZ6q_requestError",
			"row": "tCdZ6q_row",
			"sectionLabel": "tCdZ6q_sectionLabel",
			"separator": "tCdZ6q_separator",
			"sourceCard": "tCdZ6q_sourceCard",
			"sourceCode": "tCdZ6q_sourceCode",
			"sourcePanel": "tCdZ6q_sourcePanel",
			"sourceTab": "tCdZ6q_sourceTab",
			"sourceTabActive": "tCdZ6q_sourceTabActive",
			"sourceTabs": "tCdZ6q_sourceTabs",
			"statusLabel": "tCdZ6q_statusLabel",
			"switch": "tCdZ6q_switch",
			"title": "tCdZ6q_title",
			"visuallyHidden": "tCdZ6q_visuallyHidden"
		};
		//#endregion
		...
		function leadingFor(state) {
			switch (state) {
				case "error": return (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.StateDot, { state: "error" });
				case "stopped": return (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.StateDot, { state: "warning" });
				default: return (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconCodeOutline16, { size: 14 });
			}
		}
						...
						children: [
							hasSource && activeCode !== null && (0, react_jsx_runtime.jsxs)("section", {
								...
								children: [(0, react_jsx_runtime.jsx)("div", {
									...
									children: (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.CodeBlock, {
										code: activeCode,
										lang: "javascript",
							...
							inspect !== void 0 && (0, react_jsx_runtime.jsxs)("button", {
								...
								onClick: inspect,
								children: [(0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconInspectOutline12, {}), "Inspect"]
							})
						]
					})
				})]
		...
		*/
				...
				children: [
					(0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							(0, react_jsx_runtime.jsx)("span", {
								className: CordisRunRow_module_css_default.icon,
								children: card.state === "error" ? (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.StateDot, { state: "error" }) : card.state === "stopped" ? (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.StateDot, { state: "warning" }) : (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconCodeOutline16, { size: 14 })
							}),
							(0, react_jsx_runtime.jsx)("span", {
								className: CordisRunRow_module_css_default.title,
		...
		//#endregion
		//#region \0dsh-css:deepseek-harness/packages/extensions/ui-cordis/src/client/CordisPanel.module.css.mjs
		const css = ".kuOQDq_layer{flex:none;align-items:center;width:100%;height:42px;margin:8px 0 0;display:flex;position:relative}.kuOQDq_footerButtons{align-items:center;width:100%;display:flex}.kuOQDq_badge{width:calc(100% + 4px);height:42px;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border:none;border-radius:12px;align-items:center;gap:8px;margin:0 -2px;padding:0 10px 0 8px;font-family:inherit;font-size:14px;display:inline-flex;overflow:hidden}.kuOQDq_badge:hover,.kuOQDq_badge[data-active]{background:var(--dsw-alias-interactive-bg-hover)}.kuOQDq_badgeLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.kuOQDq_badgeCount{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;flex:none;margin-left:auto;font-size:12px;line-height:16px}.kuOQDq_layer.kuOQDq_rail{width:36px;height:36px;margin:0}.kuOQDq_rail .kuOQDq_badge{border-radius:50%;justify-content:center;gap:0;width:36px;height:36px;padding:0}.kuOQDq_rail .kuOQDq_footerButtons{flex-direction:column;gap:2px}.kuOQDq_panel{z-index:30;border:1px solid var(--dsw-alias-border-inverted);background:var(--dsw-specific-menu);width:420px;max-width:calc(100vw - 24px);max-height:60vh;box-shadow:var(--dsw-shadow-lv3);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:12px;flex-direction:column;display:flex;position:fixed;overflow:hidden}.kuOQDq_header{box-sizing:border-box;flex:none;justify-content:space-between;align-items:center;min-height:44px;padding:10px 12px;display:flex}.kuOQDq_body{flex:1;min-height:0;padding:0 12px 12px;overflow-y:auto}.kuOQDq_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:500;line-height:20px}.kuOQDq_note,.kuOQDq_readError{color:var(--dsw-alias-label-tertiary);margin:4px 0;font-size:12px;line-height:18px}.kuOQDq_readError{color:var(--dsw-alias-state-error-primary)}.kuOQDq_group{color:var(--dsw-alias-label-caption);text-transform:uppercase;letter-spacing:.04em;margin:8px 0;font-size:11px;font-weight:500;line-height:16px}.kuOQDq_rows{flex-direction:column;gap:8px;margin:0;padding:0;list-style:none;display:flex}.kuOQDq_row{border:1px solid var(--dsw-alias-border-l2);border-radius:12px;flex-direction:column;gap:8px;padding:14px 12px 10px;display:flex}.kuOQDq_row[data-cordis-awaiting]{border-color:var(--dsw-alias-state-business-primary)}.kuOQDq_rowHead{align-items:center;gap:8px;display:flex}.kuOQDq_rowId{color:var(--dsw-alias-label-tertiary);font-family:var(--dsh-font-mono,monospace);flex:none;font-size:11px;line-height:20px}.kuOQDq_rowName{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.kuOQDq_rowStatus{background:var(--dsw-alias-button-ghost-active-fill);height:20px;color:var(--dsw-alias-label-caption);border-radius:10px;flex:none;align-items:center;padding:0 6px;font-size:11px;line-height:20px;display:inline-flex}.kuOQDq_row[data-cordis-status=idle] .kuOQDq_rowStatus{background:var(--dsw-alias-button-ghost-active-fill);color:var(--dsw-alias-label-caption)}.kuOQDq_row[data-cordis-status=awaiting-approval] .kuOQDq_rowStatus,.kuOQDq_row[data-cordis-status=client-pending] .kuOQDq_rowStatus{background:var(--dsw-alias-state-warn-tertiary);color:var(--dsw-alias-state-warn-label)}.kuOQDq_row[data-cordis-status=failed] .kuOQDq_rowStatus{background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary)}.kuOQDq_row[data-cordis-status=running] .kuOQDq_rowStatus{background:var(--dsw-alias-state-success-tertiary);color:var(--dsw-alias-state-success-primary)}.kuOQDq_rowDetail{align-items:center;gap:8px;min-height:28px;display:flex}.kuOQDq_versionPicker{color:var(--dsw-alias-label-caption);align-items:center;gap:8px;font-size:11px;line-height:18px;display:flex}.kuOQDq_versionPicker select{border:1px solid var(--dsw-alias-border-l2);min-width:0;height:26px;color:var(--dsw-alias-label-secondary);font:inherit;background:0 0;border-radius:7px;flex:1;padding:0 8px}.kuOQDq_rowPurpose{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:12px;line-height:18px;overflow:hidden}.kuOQDq_rowError{color:var(--dsw-alias-state-error-primary);font-size:12px;line-height:18px}.kuOQDq_rowActions{flex:none;align-items:center;gap:10px;display:flex}.kuOQDq_transition{min-width:0;color:var(--dsw-alias-label-caption);align-items:center;gap:8px;font-size:11px;line-height:18px;display:flex}.kuOQDq_transitionActions{gap:6px;margin-left:auto;display:flex}.kuOQDq_transitionActions button{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border-radius:999px;padding:2px 8px}.kuOQDq_transitionActions button:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.kuOQDq_transitionActions button:disabled{opacity:.4;cursor:default}.kuOQDq_activeVersion{color:var(--dsw-alias-label-caption);font-size:11px;line-height:16px}.kuOQDq_actionButton{width:28px;height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:999px;justify-content:center;align-items:center;padding:0;display:inline-flex}.kuOQDq_actionButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.kuOQDq_actionButton:disabled{opacity:.4;cursor:default}.kuOQDq_doubleCheck{width:17px;height:14px;display:inline-block;position:relative}.kuOQDq_doubleCheck svg{position:absolute;top:1px}.kuOQDq_doubleCheck svg:first-child{opacity:.7;left:0}.kuOQDq_doubleCheck svg:last-child{left:5px}";
		const tagId = "@xharness/dsh-client-ui-cordis/CordisPanel.module.css";
		...
		var CordisPanel_module_css_default = {
			"actionButton": "kuOQDq_actionButton",
			"activeVersion": "kuOQDq_activeVersion",
			"badge": "kuOQDq_badge",
			"badgeCount": "kuOQDq_badgeCount",
			"badgeLabel": "kuOQDq_badgeLabel",
			"body": "kuOQDq_body",
			"doubleCheck": "kuOQDq_doubleCheck",
			"footerButtons": "kuOQDq_footerButtons",
			"group": "kuOQDq_group",
			"header": "kuOQDq_header",
			"layer": "kuOQDq_layer",
			"note": "kuOQDq_note",
			"panel": "kuOQDq_panel",
			"rail": "kuOQDq_rail",
			"readError": "kuOQDq_readError",
			"row": "kuOQDq_row",
			"rowActions": "kuOQDq_rowActions",
			"rowDetail": "kuOQDq_rowDetail",
			"rowError": "kuOQDq_rowError",
			"rowHead": "kuOQDq_rowHead",
			"rowId": "kuOQDq_rowId",
			"rowName": "kuOQDq_rowName",
			"rowPurpose": "kuOQDq_rowPurpose",
			"rowStatus": "kuOQDq_rowStatus",
			"rows": "kuOQDq_rows",
			"title": "kuOQDq_title",
			"transition": "kuOQDq_transition",
			"transitionActions": "kuOQDq_transitionActions",
			"versionPicker": "kuOQDq_versionPicker"
		};
		//#endregion
		...
		function DoubleCheckIcon() {
			return (0, react_jsx_runtime.jsxs)("span", {
				...
				"aria-hidden": true,
				children: [(0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconCheckOutline16, { size: 12 }), (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconCheckOutline16, { size: 12 })]
			});
		}
		...
		function CordisPanel({ wide, useSessions, useInventory, useActiveRuns, useRunErrors, useLoaded, useRenderFailures, onApprove, onDecline, onRun, onStop, onRemove, onRefresh, t }) {
			...
			(0, _xharness_dsh_client_ui_primitives.useDismissOnOutsidePointer)(rootRef, open, setOpen);
			(0, react.useEffect)(() => {
							...
							children: [(0, react_jsx_runtime.jsx)("span", {
								...
								children: [
									...
									awaiting === void 0 && listed !== void 0 && selectedPackageId !== void 0 && listed.activeRun === void 0 && (0, react_jsx_runtime.jsx)(RowAction, {
										...
										children: (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconPlayOutline16, { size: 14 })
									}),
									...
									awaiting === void 0 && listed !== void 0 && listed.activeRun !== void 0 && (0, react_jsx_runtime.jsx)(RowAction, {
										...
										children: (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconStopFill16, { size: 14 })
									}),
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [open && anchor !== void 0 && (0, react_jsx_runtime.jsxs)("section", {
					...
					children: (0, react_jsx_runtime.jsxs)("button", {
						...
						children: [(0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconCordisPluginOutline14, { size: wide ? 16 : 18 }), wide && (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [(0, react_jsx_runtime.jsx)("span", {
