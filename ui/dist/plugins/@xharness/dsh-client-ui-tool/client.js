window.__ModuleLoader__.load({
	id: "@xharness/dsh-client-ui-tool",
	factory: (require) => {
		var module = { exports: {} };
		...
		*/
		function toolRowModel(toolName, block, cwd, home) {
			...
			const base = argsRaw === "" ? block.callId : (0, _xharness_dsh_client_runtime_client.abbreviateHomePath)(relativizeToCwd(deriveSummary(variant, argsRaw), cwd), home);
		...
		*/
		function readCardModel(block, sessionCwd, home) {
			...
			return {
				label: result.title ?? (0, _xharness_dsh_client_runtime_client.abbreviateHomePath)(relativizeToCwd(result.path, sessionCwd), home),
				lines,
		...
		*/
		function resolveTerminalCwd(viewCwd, sessionCwd) {
			...
			return normalizeSegments((0, _xharness_dsh_client_runtime_client.resolveWorkspacePath)(sessionCwd, viewCwd));
		}
		/**
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:deepseek-harness/packages/client/ui-tool/src/client/tool/components/ToolRow.module.css.mjs
		const css$3 = ".Dh215a_root{flex-direction:column;display:flex}.Dh215a_row{position:relative;overflow:hidden}.Dh215a_root[data-state=running] .Dh215a_row:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite Dh215a_dsh-tool-row-sweep;position:absolute;top:0;bottom:0;left:0}@keyframes Dh215a_dsh-tool-row-sweep{0%{left:-300px}90%,to{left:100%}}.Dh215a_leading{flex-shrink:0}.Dh215a_root[data-tool^=cordis_] .Dh215a_leading,.Dh215a_root[data-tool^=cordis_] .Dh215a_title{color:var(--dsw-alias-state-business-primary)}.Dh215a_root[data-tool^=cordis_] .Dh215a_title{font-weight:500}.Dh215a_root[data-tool^=cordis_] .Dh215a_sep{background:var(--dsw-alias-state-business-primary)}.Dh215a_chevron{color:var(--dsw-alias-label-secondary)}.Dh215a_title{font-weight:400}.Dh215a_sep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.Dh215a_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.Dh215a_summarySuffix{white-space:nowrap;color:var(--dsw-alias-label-tertiary);flex:none;margin-left:4px;font-size:14px;line-height:24px}.Dh215a_fileLink{text-overflow:ellipsis;white-space:nowrap;min-width:0;font:inherit;text-align:left;color:var(--dsw-alias-label-secondary);text-decoration:underline;text-decoration-color:var(--dsw-alias-label-quaternary);text-underline-offset:3px;cursor:pointer;background:0 0;border:none;flex:auto;margin:0;padding:0;font-size:14px;line-height:24px;overflow:hidden}.Dh215a_fileLink:hover{color:var(--dsw-alias-label-primary);text-decoration-color:currentColor}.Dh215a_errorSummary{color:var(--dsw-alias-state-error-primary)}.Dh215a_bodyWrap{flex-direction:column;display:flex}.Dh215a_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.Dh215a_root:hover .Dh215a_inspectButton,.Dh215a_inspectButton:focus-visible{opacity:1}.Dh215a_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.Dh215a_bodyScroll{max-height:260px;overflow-y:auto}.Dh215a_ioCard{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);font:var(--dsw-font-markdown-code-block-small);border-radius:12px;flex-direction:column;margin:4px 0 4px 4px;display:flex}.Dh215a_ioSection{grid-template-columns:max-content 1fr;align-items:baseline;column-gap:14px;max-height:150px;padding:12px 16px;display:grid;overflow-y:auto}.Dh215a_ioSection::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}.Dh215a_ioSection::-webkit-scrollbar-track{margin:6px 0}.Dh215a_ioLabel{color:var(--dsw-alias-label-caption);align-self:start;position:sticky;top:0}.Dh215a_ioDivider{background:var(--dsw-alias-border-l2);flex:none;height:1px}.Dh215a_ioText{white-space:pre-wrap;word-break:break-word;min-width:0;color:var(--dsw-alias-label-secondary)}.Dh215a_ioText[data-error]{color:var(--dsw-alias-state-error-primary)}.Dh215a_codeBody,.Dh215a_terminalBody,.Dh215a_diffBody,.Dh215a_readBody,.Dh215a_searchBody,.Dh215a_webBody{margin:4px 0 4px 4px}.Dh215a_searchRecovery{white-space:pre-wrap;overflow-wrap:anywhere;font:var(--dsw-font-xs-13);color:var(--dsw-alias-label-tertiary);margin:4px 0 4px 4px}.Dh215a_codeBody{--dsl-code-block-content-font:var(--dsw-font-markdown-code-block-small)}.Dh215a_terminalBody{--dsl-terminal-font:var(--dsw-font-markdown-code-block-small);--dsl-terminal-line-height:18px;--dsl-terminal-output-max-height:224px;border:1px solid var(--dsw-alias-border-l1)}.Dh215a_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		const tagId$3 = "@xharness/dsh-client-ui-tool/ToolRow.module.css";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId$3) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "@xharness/dsh-client-ui-tool";
		...
		*  summary already describe a settled row). */
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [status !== null && (0, react_jsx_runtime.jsx)("span", {
					...
					children: (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [terminalBody !== null ? (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.TerminalBlock, {
							...terminalBody.card,
							maxLines: Infinity,
							labels: terminalBlockLabels(t),
							className: ToolRow_module_css_default.terminalBody
						}) : diffBody !== null ? (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.DiffBlock, {
							...diffBody.card,
							maxLines: 8,
						...
						}) : searchBody !== null ? (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [(0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.SearchBlock, {
							...searchBody.card,
							maxLines: 8,
						...
						})] }) : webBody !== null ? (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.WebBlock, {
							...webBody,
		...
		const VARIANT_ICONS = {
			search: (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconSearchOutline16, { size: 14 }),
			read: (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconBrowseOutline16, { size: 14 }),
			bash: (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconApiOutline14, { size: 14 }),
			write: (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconEditOutline16, { size: 14 }),
			edit: (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconEditOutline16, { size: 14 }),
			code: (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconCodeOutline16, { size: 14 }),
			others: (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconSparkle16, { size: 14 })
		};
		...
		//#endregion
		//#region \0dsh-css:deepseek-harness/packages/client/ui-tool/src/client/tool/ToolCallTree.module.css.mjs
		const css$2 = ".JWd3IW_callRow{border-radius:6px}.JWd3IW_subCalls{border-left:1px solid var(--dsw-alias-border-l2);flex-direction:column;gap:4px;margin:4px 0 2px 22px;padding-left:8px;display:flex}";
		const tagId$2 = "@xharness/dsh-client-ui-tool/ToolCallTree.module.css";
		...
		var ToolCallTree_module_css_default = {
			"callRow": "JWd3IW_callRow",
			"subCalls": "JWd3IW_subCalls"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:deepseek-harness/packages/client/ui-tool/src/client/tool/ToolDetails.module.css.mjs
		const css$1 = "._7Dw-cG_description{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);margin:0 0 6px}._7Dw-cG_cardBody{margin:0}._7Dw-cG_recovery{white-space:pre-wrap;overflow-wrap:anywhere;color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);margin:6px 0 0}._7Dw-cG_code{background:var(--dsw-alias-markdown-code-block);font-family:var(--ds-font-family-code);color:var(--dsw-alias-label-primary);white-space:pre-wrap;word-break:break-word;border-radius:12px;margin:0;padding:16px;font-size:13px;line-height:22px}._7Dw-cG_code[data-error]{color:var(--dsw-alias-state-error-primary)}._7Dw-cG_read,._7Dw-cG_web{margin:0}._7Dw-cG_empty{color:var(--dsw-alias-label-tertiary);padding:8px 0;font-size:13px;line-height:20px}";
		const tagId$1 = "@xharness/dsh-client-ui-tool/ToolDetails.module.css";
		...
		var ToolDetails_module_css_default = {
			"cardBody": "_7Dw-cG_cardBody",
			"code": "_7Dw-cG_code",
			"description": "_7Dw-cG_description",
			"empty": "_7Dw-cG_empty",
			"read": "_7Dw-cG_read",
			"recovery": "_7Dw-cG_recovery",
			"web": "_7Dw-cG_web"
		};
		//#endregion
		...
		*/
		function ToolDetails({ block, cwd, useHostDescription, t }) {
			...
			}) : null, (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.TerminalBlock, {
				...terminal.card,
				labels: terminalBlockLabels(t),
				className: ToolDetails_module_css_default.cardBody
			})] });
			const read = readCardModel(block, cwd, home);
			if (read !== null) return (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.ReadBlock, {
				...read,
				className: ToolDetails_module_css_default.read
			});
			const diff = diffCardModel(block);
			if (diff !== null) return (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.DiffBlock, {
				...diff.card,
				className: ToolDetails_module_css_default.cardBody
			});
			const search = searchCardModel(block);
			if (search !== null) return (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [(0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.SearchBlock, {
				...search.card,
				className: ToolDetails_module_css_default.cardBody
			...
			if (web !== null) {
				...
				return (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [(0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.WebBlock, {
					...web,
		...
		*  Input/Output sections, ToolRow's unified expand). */
		function AskQuestionRow({ toolName, block, inspect, t }) {
			...
			return (0, react_jsx_runtime.jsx)(ToolRow, {
				...
				variant: model.variant,
				toolName,
				icon: (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconQuestionOutline14, {}),
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:deepseek-harness/packages/client/ui-tool/src/client/tool/toolviews/bash-sample.module.css.mjs
		const css = ".ANgngG_card{flex-direction:column;display:flex}.ANgngG_terminal{--dsl-terminal-font:var(--dsw-font-markdown-code-block-small);--dsl-terminal-line-height:18px;--dsl-terminal-output-max-height:224px;border:1px solid var(--dsw-alias-border-l1);margin:4px 0 4px 4px}.ANgngG_ioCard{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);font:var(--dsw-font-markdown-code-block-small);border-radius:12px;flex-direction:column;margin:4px 0 4px 4px;display:flex}.ANgngG_ioSection{grid-template-columns:max-content 1fr;align-items:baseline;column-gap:14px;max-height:150px;padding:12px 16px;display:grid;overflow-y:auto}.ANgngG_ioSection::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}.ANgngG_ioSection::-webkit-scrollbar-track{margin:6px 0}.ANgngG_ioLabel{color:var(--dsw-alias-label-caption);align-self:start;position:sticky;top:0}.ANgngG_ioDivider{background:var(--dsw-alias-border-l2);flex:none;height:1px}.ANgngG_ioText{white-space:pre-wrap;word-break:break-word;min-width:0;color:var(--dsw-alias-label-secondary)}.ANgngG_ioText[data-error]{color:var(--dsw-alias-state-error-primary)}.ANgngG_root[data-expandable]{cursor:pointer}.ANgngG_root{align-items:center;min-width:0;height:24px;display:flex;position:relative;overflow:hidden}.ANgngG_root[data-state=running]:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite ANgngG_dsh-bash-row-sweep;position:absolute;top:0;bottom:0;left:0}@keyframes ANgngG_dsh-bash-row-sweep{0%{left:-300px}90%,to{left:100%}}.ANgngG_leading{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:6px;display:inline-flex;position:relative}.ANgngG_chevron{color:var(--dsw-alias-label-secondary)}.ANgngG_iconIdle{opacity:1;transition:opacity .1s;display:inline-flex}.ANgngG_chevronHover{opacity:0;margin:auto;transition:opacity .1s;position:absolute;inset:0}.ANgngG_root:hover .ANgngG_iconIdle{opacity:0}.ANgngG_root:hover .ANgngG_chevronHover{opacity:1}.ANgngG_title{color:var(--dsw-alias-label-secondary);flex:none;font-size:14px;line-height:24px}.ANgngG_sep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.ANgngG_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.ANgngG_errorSummary{color:var(--dsw-alias-state-error-primary)}.ANgngG_bodyWrap{flex-direction:column;display:flex}.ANgngG_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.ANgngG_card:hover .ANgngG_inspectButton,.ANgngG_inspectButton:focus-visible{opacity:1}.ANgngG_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.ANgngG_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		const tagId = "@xharness/dsh-client-ui-tool/bash-sample.module.css";
		...
		var bash_sample_module_css_default = {
			"bodyWrap": "ANgngG_bodyWrap",
			"card": "ANgngG_card",
			"chevron": "ANgngG_chevron",
			"chevronHover": "ANgngG_chevronHover",
			"dsh-bash-row-sweep": "ANgngG_dsh-bash-row-sweep",
			"errorSummary": "ANgngG_errorSummary",
			"iconIdle": "ANgngG_iconIdle",
			"inspectButton": "ANgngG_inspectButton",
			"ioCard": "ANgngG_ioCard",
			"ioDivider": "ANgngG_ioDivider",
			"ioLabel": "ANgngG_ioLabel",
			"ioSection": "ANgngG_ioSection",
			"ioText": "ANgngG_ioText",
			"leading": "ANgngG_leading",
			"root": "ANgngG_root",
			"sep": "ANgngG_sep",
			"summary": "ANgngG_summary",
			"terminal": "ANgngG_terminal",
			"title": "ANgngG_title",
			"visuallyHidden": "ANgngG_visuallyHidden"
		};
		//#endregion
		...
		function leadingFor(state) {
			switch (state) {
				case "error": return (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.StateDot, { state: "error" });
				case "stopped": return (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.StateDot, { state: "warning" });
				default: return (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconApiOutline14, { size: 14 });
			}
		}
		...
		*/
		function BashRow({ toolName, block, sessionId, useSessions, inspect, t }) {
			...
			const leading = open ? (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconChevronDownOutline14, { className: bash_sample_module_css_default.chevron }) : expandable ? (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [(0, react_jsx_runtime.jsx)("span", {
				className: bash_sample_module_css_default.iconIdle,
				children: leadingFor(state)
			}), (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconChevronDownOutline14, { className: clsx(bash_sample_module_css_default.chevron, bash_sample_module_css_default.chevronHover) })] }) : leadingFor(state);
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [(0, react_jsx_runtime.jsxs)("div", {
					...
					children: [terminal !== null ? (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.TerminalBlock, {
						...terminal.card,
						maxLines: Infinity,
						labels: terminalBlockLabels(t),
		...
		*/
		function FileMutationRow({ toolName, block, cwd, home, openFile, inspect, t }) {
			...
			return (0, react_jsx_runtime.jsx)(ToolRow, {
				...
				variant: model.variant,
				toolName,
				icon: (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconEditOutline16, { size: 14 }),
				title: model.title,
		...
		*/
		function ReadRow({ toolName, block, cwd, home, openFile, inspect, t }) {
			...
			return (0, react_jsx_runtime.jsx)(ToolRow, {
				...
				variant: model.variant,
				toolName,
				icon: (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconBrowseOutline16, { size: 14 }),
				title: model.title,
				summary: model.summary,
				body: null,
				output: model.output,
		...
		*/
		function SearchRow({ toolName, block, inspect, t }) {
			...
			return (0, react_jsx_runtime.jsx)(ToolRow, {
				...
				variant: model.variant,
				toolName,
				icon: (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconSearchOutline16, { size: 14 }),
		...
		*  must not read as a completed update. */
		function TodoRow({ toolName, block, inspect, t }) {
			...
			return (0, react_jsx_runtime.jsx)(ToolRow, {
				...
				variant: model.variant,
				toolName,
				icon: (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconChecklistOutline14, {}),
