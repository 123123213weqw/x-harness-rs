window.__ModuleLoader__.load({
	id: "@xharness/dsh-cordis-client-runner",
	factory: (require) => {
		var module = { exports: {} };
...
call: (method, args = null) => env.invoke(method, args) }, harnessTrap(), ...Object.values(traps), void 0, void 0);
		...
		*/
		...
		function denyContext(value, service, env) {
			if (value instanceof _xharness_cordis.Context) return rejectGuard(env, `service "${service}" returned a cordis Context, which the dynamic facade does not expose. Operate through your own plugin ctx and the services you declared — never another context.`);
			return value;
		}
		/**
		...
		* docs cannot diverge.
		*
		* @module @xharness/dsh-cordis-client-runner/client/api-catalog
		*/
		...
		*/
		...
		var ClientTimerService = class extends _xharness_cordis.Service {
