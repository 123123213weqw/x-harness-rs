	...
	factory: (require) => {
		...
		*/
		function MessageFeedbackActions({ messageId, ensure, rate, toggle, clearNote, useFeedback, t }) {
			...
			const pos = (0, _xharness_dsh_client_ui_primitives.useAnchoredPosition)({
				open: noteOpen,
			...
			return (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
				(0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.Tooltip, {
					...
					children: (0, react_jsx_runtime.jsx)("button", {
						...
						children: (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconLikeOutline16, {})
					})
				}),
				(0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.Tooltip, {
					label: dislikeLabel,
					...
					children: (0, react_jsx_runtime.jsx)("button", {
						...
						children: (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconDislikeOutline16, {})
					})
				}),
