window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:deepseek-harness/packages/client/ui-agent-preset/src/client/AgentPresetLabel.module.css.mjs
		const css$3 = ".ie6uwG_label{background:var(--dsw-alias-fill-tsp-secondary);max-width:180px;height:22px;color:var(--dsw-alias-label-secondary);white-space:nowrap;text-overflow:ellipsis;border-radius:6px;align-items:center;gap:4px;padding:0 2px 0 0;font-size:12px;line-height:22px;display:inline-flex;overflow:hidden}.ie6uwG_icon{opacity:.7;flex:none}";
		const tagId$3 = "@xharness/dsh-client-ui-agent-preset/AgentPresetLabel.module.css";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId$3) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "@xharness/dsh-client-ui-agent-preset";
		...
		*/
		function AgentPresetLabel({ sessionId, useSessions, useAgentPresets, load, t }) {
			...
			return (0, react_jsx_runtime.jsxs)("span", {
				...
				children: [(0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconAgentPresetOutline16, {
					size: 14,
		...
		function AgentPresetSeat({ load, select, introduced, useAgentPresetSeat, t }) {
			...
			return (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.Menu, {
				...
				anchor: (0, react_jsx_runtime.jsxs)("button", {
					...
					children: [
						(0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconAgentPresetOutline16, { className: introducing ? `${AgentPresetSeat_module_css_default.seatIcon} ${AgentPresetSeat_module_css_default.introIcon}` : AgentPresetSeat_module_css_default.seatIcon }),
						shownLabel,
						(0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconChevronDownOutline14, { className: AgentPresetSeat_module_css_default.chevron })
					]
				})
			});
		}
		...
		*/
		...
		var AgentPresetSettingsController = class {
			...
			store = (0, _xharness_dsh_client_runtime_client.createSnapshotStore)(INITIAL$2);
			/**
		...
		*/
		...
		var AgentPresetSectionController = class {
			...
			store = (0, _xharness_dsh_client_runtime_client.createSnapshotStore)(INITIAL$1);
		...
		*/
		function AgentPresetSection(props) {
			...
			const creatorButton = props.startCreatorDraft !== void 0 && state.rows.some((row) => row.id === "cordis") ? (0, react_jsx_runtime.jsxs)("button", {
				...
				children: [(0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconPlusOutline16, { size: 14 }), t("creatorDraft")]
			}) : null;
			return (0, react_jsx_runtime.jsxs)("div", {
				className: AgentPresetSection_module_css_default.section,
				children: [
											...
											(0, react_jsx_runtime.jsxs)("div", {
												...
												children: [
													row.trust === "system" ? row.broken === void 0 ? (0, react_jsx_runtime.jsx)("button", {
														...
														children: (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconBrowseOutline16, {})
														...
														children: (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconFolderOpenOutline16, {})
													}),
													(0, react_jsx_runtime.jsx)("button", {
														type: "button",
														className: AgentPresetSection_module_css_default.iconButton,
														...
														children: (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconCopyOutline16, {})
													}),
													row.trust === "user" ? (0, react_jsx_runtime.jsx)("button", {
														...
														children: (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconTrashOutline16, {})
													}) : null
												]
											}),
					...
					(0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.Modal, {
						...
						className: AgentPresetSection_module_css_default.dialog,
						footer: (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.Button, {
							variant: "outline",
							autoFocus: true,
							onClick: () => {
								props.closeView();
		...
		*/
		...
		var AgentPresetSeatController = class {
			...
			store = (0, _xharness_dsh_client_runtime_client.createSnapshotStore)(INITIAL);
			/**
