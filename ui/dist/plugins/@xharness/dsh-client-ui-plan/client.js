window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:deepseek-harness/packages/client/ui-plan/src/client/PlanModeControl.module.css.mjs
		const css = "._NETUa_wrap{align-items:center;gap:6px;display:inline-flex}._NETUa_chip{background:var(--dsw-alias-state-warn-tertiary);min-width:34px;color:var(--dsw-alias-state-warn-label);cursor:pointer;border:none;border-radius:999px;align-items:center;gap:4px;padding:2px 8px;font-size:13px;font-weight:500;line-height:20px;display:inline-flex}._NETUa_chip:hover:not(:disabled){color:var(--dsw-alias-state-warn-primary)}._NETUa_chip:focus-visible{outline:2px solid var(--dsw-alias-state-warn-label);outline-offset:2px}._NETUa_chip:disabled{opacity:.6;cursor:default}._NETUa_close{color:currentColor;align-items:center;display:inline-flex}._NETUa_error{color:var(--dsw-alias-state-error-primary);font-size:12px;line-height:18px}";
		const tagId = "@xharness/dsh-client-ui-plan/PlanModeControl.module.css";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "@xharness/dsh-client-ui-plan";
