window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		/**
		* Twin of `normalizeApiKey` in `@xharness/dsh-llm`: printable ASCII, space
			...
			return (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [
							...
							children: [(0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									(0, react_jsx_runtime.jsx)("button", {
										...
										children: expanded.has(index) ? (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconChevronDownOutline14, {}) : (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconChevronRightOutline14, {})
									}),
									(0, react_jsx_runtime.jsx)("button", {
										type: "button",
					...
					(0, react_jsx_runtime.jsxs)("button", {
						...
						children: [(0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconPlusOutline16, { size: 14 }), props.t("addModel")]
					})
				]
			});
		}
 ...
 ...typeof candidate.imageInput === "boolean" ? {imageInput:candidate.imageInput} : {},
      ...
      children: [(0,react_jsx_runtime.jsxs)('label',{className:ModelsSection_module_css_default['modelField'],children:[
		...
		*/
					...
					(0, react_jsx_runtime.jsx)("div", {
						...
						children: addTarget !== void 0 && addNamespace !== void 0 ? (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [(0, react_jsx_runtime.jsxs)("button", {
								...
								children: [(0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconPlusOutline16, { size: 14 }), t("add")]
							}), (0, react_jsx_runtime.jsxs)("button", {
								type: "button",
								className: ModelsSection_module_css_default["addButton"],
								...
								children: [(0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconPlusOutline16, { size: 14 }), t("customAdd")]
							})]
						})
					}),
		...
		//#endregion
		//#region \0dsh-css:deepseek-harness/packages/client/ui-settings-models/src/client/OnboardingModal.module.css.mjs
		const css$2 = "._5TDjIa_dialog{width:min(600px,100%);padding:0}._5TDjIa_content{box-sizing:border-box;flex-direction:column;max-height:calc(100vh - 48px);padding:28px;display:flex;overflow-y:auto}._5TDjIa_title{color:var(--dsw-alias-label-primary);outline:none;margin:0;font-size:20px;font-weight:500;line-height:28px}._5TDjIa_body{margin-top:20px}@media (width<=560px){._5TDjIa_content{padding:24px}}";
		const tagId$2 = "@xharness/dsh-client-ui-settings-models/OnboardingModal.module.css";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:deepseek-harness/packages/client/ui-settings-models/src/client/DeepSeekOnboardingDialog.module.css.mjs
		const css$1 = "._2WZCNq_description{color:var(--dsw-alias-label-secondary);margin:0;font-size:14px;line-height:24px}._2WZCNq_editor{margin-top:24px}@media (width<=560px){._2WZCNq_editor{margin-top:20px}}";
		const tagId$1 = "@xharness/dsh-client-ui-settings-models/DeepSeekOnboardingDialog.module.css";
