	...
	factory: (require) => {
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					edges.left && (0, react_jsx_runtime.jsx)("button", {
						...
						children: (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconChevronLeftOutline14, {})
					}),
					(0, react_jsx_runtime.jsx)("div", {
						...
						children: items.map((item) => item.attachment.kind === 'file' ? (0,react_jsx_runtime.jsx)(XHarnessFileCard,{name:item.attachment.file.name,bytes:item.attachment.file.size,onRemove:()=>onRemove(item),removeLabel:item.removeLabel},item.id) : (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [(0, react_jsx_runtime.jsx)("button", {
								...
								children: (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconCloseFill14, { size: 12 })
							})]
						}, item.id))
					}),
			...
			return (0, react_dom.createPortal)((0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					(0, react_jsx_runtime.jsx)("button", {
						...
						onClick: onClose,
						children: (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconCloseOutline16, { size: 16 })
					})
				]
			}), document.body);
		}
		...
		*/
		function dropOverlayLabels(t, accepting, limits) {
			...
			return {
				title: "拖入图片或文件",
				desc: "图片 ≤ 20 MiB / 张，普通文件 ≤ 32 MiB；本次合计 ≤ 96 MiB"
			};
		}
		/**
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:deepseek-harness/packages/client/ui-attachment/src/client/ComposerAttachments.module.css.mjs
		const css$1 = ".ArGB1q_rail{min-width:0;padding:4px 12px 0}";
		const tagId$1 = "@xharness/dsh-client-ui-attachment/ComposerAttachments.module.css";
		...
		var ComposerAttachments_module_css_default = { "rail": "ArGB1q_rail" };
		//#endregion
		...
		* renders large, several render as 64px square tiles (DeepSeek Chat rule). */
		function ImageGallery({ images, load, align, labels }) {
			...
			return (0, react_jsx_runtime.jsx)("div", {
				...
				"data-align": align,
				children: images.map((image, index) => image.kind === 'file' || image.attachment.width == null ? (0,react_jsx_runtime.jsx)(XHarnessHistoryFile,{attachment:image.attachment,load},image.attachment.attachmentId+':'+index) : (0, react_jsx_runtime.jsx)(MessageImage, {
					...image,
					load,
					variant,
					labels
