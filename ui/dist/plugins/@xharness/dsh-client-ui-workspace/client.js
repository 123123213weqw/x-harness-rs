window.__ModuleLoader__.load({
	id: "@xharness/dsh-client-ui-workspace",
	factory: (require) => {
		...
		*/
		function deriveGroups(list, workspaces, archivedSessionIds, view) {
			...
			const descendants = (0, _xharness_dsh_client_runtime_client.indexSubagentDescendants)(list.byId);
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:deepseek-harness/packages/client/ui-workspace/src/client/rows/Rows.module.css.mjs
		const css$2 = ".PT4Uyq_projectRow,.PT4Uyq_sessionRow{cursor:pointer;user-select:none;color:var(--dsw-alias-label-primary);border-radius:8px;align-items:center;gap:6px;padding:0 8px;display:flex}.PT4Uyq_projectRow:hover,.PT4Uyq_sessionRow:hover,.PT4Uyq_sessionRow.PT4Uyq_selected{background:var(--dsw-alias-interactive-bg-hover)}.PT4Uyq_searchResultRow{box-sizing:border-box;cursor:pointer;text-align:left;width:100%;min-height:48px;color:var(--dsw-alias-label-primary);background:0 0;border:none;border-radius:8px;flex-direction:column;align-items:stretch;padding:4px 8px;display:flex}.PT4Uyq_searchResultRow:hover,.PT4Uyq_searchResultRow.PT4Uyq_selected{background:var(--dsw-alias-interactive-bg-hover)}.PT4Uyq_searchResultHeading{align-items:center;min-width:0;display:flex}.PT4Uyq_searchResultTitle{text-overflow:ellipsis;white-space:nowrap;min-width:0;margin-left:4px;font-size:14px;line-height:20px;overflow:hidden}.PT4Uyq_searchResultMeta{align-items:center;gap:6px;min-width:0;margin-left:20px;display:flex}.PT4Uyq_searchResultWorkspace,.PT4Uyq_searchResultSnippet{text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:17px;overflow:hidden}.PT4Uyq_searchResultWorkspace{max-width:40%;color:var(--dsw-alias-label-tertiary);flex:none}.PT4Uyq_searchResultSnippet{min-width:0;color:var(--dsw-alias-label-secondary);flex:1}.PT4Uyq_projectRow{box-sizing:border-box;align-items:center;height:34px}.PT4Uyq_projectRow .PT4Uyq_rowActions{height:20px}.PT4Uyq_sessionRow{height:32px;animation:PT4Uyq_row-in .15s var(--ds-ease-in-out);gap:0}.PT4Uyq_sessionRow .PT4Uyq_title{margin:0 6px 0 4px}.PT4Uyq_flatSessionRowWithoutStatus .PT4Uyq_title{margin-left:0}@keyframes PT4Uyq_row-in{0%{opacity:0}}.PT4Uyq_slot{width:16px;height:20px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;display:inline-flex}.PT4Uyq_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}.PT4Uyq_folderActive{color:var(--dsw-alias-state-business-primary)}.PT4Uyq_projectRow .PT4Uyq_chevron{display:none}.PT4Uyq_projectRow:hover .PT4Uyq_chevron{display:inline-flex}.PT4Uyq_projectRow:hover .PT4Uyq_folder{display:none}.PT4Uyq_arrow{transition:transform .15s var(--ds-ease-in-out)}.PT4Uyq_arrowOpen{transform:rotate(90deg)}.PT4Uyq_projectText{flex-direction:column;flex:1;gap:2px;min-width:0;display:flex}.PT4Uyq_title{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:14px;line-height:20px;overflow:hidden}.PT4Uyq_renameInput{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-button-elevated-fill);min-width:0;color:inherit;border-radius:4px;outline:none;padding:0 2px;font-size:14px;line-height:20px}.PT4Uyq_sessionRow .PT4Uyq_title{flex:1}.PT4Uyq_meta{text-overflow:ellipsis;white-space:nowrap;color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:20px;overflow:hidden}.PT4Uyq_time{color:var(--dsw-alias-label-tertiary);flex:none;font-size:12px;line-height:20px}.PT4Uyq_dot{flex:none}.PT4Uyq_rowActions{flex:none;align-items:center;gap:12px;display:none}.PT4Uyq_projectRow:hover .PT4Uyq_rowActions,.PT4Uyq_sessionRow:hover .PT4Uyq_rowActions,.PT4Uyq_projectRow.PT4Uyq_menuOpen .PT4Uyq_rowActions,.PT4Uyq_sessionRow.PT4Uyq_menuOpen .PT4Uyq_rowActions{display:inline-flex}.PT4Uyq_sessionRow:hover .PT4Uyq_time,.PT4Uyq_sessionRow.PT4Uyq_menuOpen .PT4Uyq_time{display:none}.PT4Uyq_projectRow.PT4Uyq_menuOpen,.PT4Uyq_sessionRow.PT4Uyq_menuOpen{background:var(--dsw-alias-interactive-bg-hover)}.PT4Uyq_sessionRow.PT4Uyq_dropBefore,.PT4Uyq_sessionRow.PT4Uyq_dropAfter{position:relative}.PT4Uyq_sessionRow.PT4Uyq_dropBefore:before,.PT4Uyq_sessionRow.PT4Uyq_dropAfter:after{content:\"\";z-index:1;background:linear-gradient(55deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 0 / 5px 7px no-repeat, linear-gradient(125deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 5px / 5px 7px no-repeat, linear-gradient(var(--dsw-alias-state-business-primary) 0 0) 4px 5px / calc(100% - 4px) 2px no-repeat;pointer-events:none;height:12px;position:absolute;left:0;right:4px}.PT4Uyq_sessionRow.PT4Uyq_dropBefore:before{top:-7px}.PT4Uyq_sessionRow.PT4Uyq_dropAfter:after{bottom:-7px}.PT4Uyq_hoverContent{flex-direction:column;gap:8px;display:flex}.PT4Uyq_hoverTitle{color:#fff;overflow-wrap:break-word;font-size:14px;line-height:20px}.PT4Uyq_hoverPath{color:#cfd3d6;word-break:break-all;font-size:12px;line-height:16px}.PT4Uyq_hoverTime{color:#cfd3d6;font-size:12px;line-height:16px}.PT4Uyq_hoverStatus{color:#adb2b8;align-items:center;gap:8px;font-size:12px;line-height:20px;display:flex}.PT4Uyq_iconButton{cursor:pointer;width:16px;height:16px;color:var(--dsw-alias-label-tertiary);background:0 0;border:none;border-radius:4px;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.PT4Uyq_iconButton:hover{color:var(--dsw-alias-label-primary)}.PT4Uyq_chevron{color:var(--dsw-alias-label-caption)}@media (prefers-reduced-motion:reduce){.PT4Uyq_sessionRow,.PT4Uyq_arrow{transition:none;animation:none}}";
		const tagId$2 = "@xharness/dsh-client-ui-workspace/Rows.module.css";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId$2) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "@xharness/dsh-client-ui-workspace";
		...
		*/
		function ProjectRowItem({ group, onToggle, onCreate, actions, drag, home, t }) {
			...
			const workspaceMenuItems = [{
				id: "rename",
				label: t("rename"),
				icon: (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconEditOutline16, {})
			}, {
				id: "delete",
				label: t("delete.workspace"),
				icon: (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconTrashOutline16, {}),
				danger: true
			}];
			const ownRow = (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					(0, react_jsx_runtime.jsx)("span", {
						...
						children: row.expanded ? (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconFolderOpen16, {}) : (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconFolderClose16, {})
					}),
					(0, react_jsx_runtime.jsx)("span", {
						className: clsx(Rows_module_css_default.slot, Rows_module_css_default.chevron),
						children: (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconTriangleRightFill14, { className: clsx(Rows_module_css_default.arrow, row.expanded && Rows_module_css_default.arrowOpen) })
					}),
					(0, react_jsx_runtime.jsx)("span", {
					...
					(0, react_jsx_runtime.jsxs)("span", {
						...
						children: [actions !== void 0 && (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.Menu, {
							open: menuOpen,
							onClose: () => {
								setMenuOpen(false);
							},
							...
							anchor: (0, react_jsx_runtime.jsx)("button", {
								...
								children: (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconEllipsisOutline16, {})
							})
							...
							children: (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconPlusOutline16, {})
						})]
					})
				]
			});
			if (row.createdAt === void 0) return ownRow;
			return (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.HoverCard, {
				anchor: ownRow,
				content: (0, react_jsx_runtime.jsx)(WorkspaceHoverContent, {
					label: row.label,
					cwd: row.cwd === void 0 ? void 0 : (0, _xharness_dsh_client_runtime_client.abbreviateHomePath)(row.cwd, home),
		...
		*/
		...
		function SessionStatusDots({ statuses }) {
			return (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [(0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.StateDot, { state: statuses[0].state }), statuses.map((status) => (0, react_jsx_runtime.jsx)("span", {
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					statuses.map((status) => (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [(0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.StateDot, { state: status.state }), (0, react_jsx_runtime.jsx)("span", { children: status.label })]
					}, status.label))
				]
			});
		}
		...
		*/
		function SessionNodeItem({ node, currentId, now, onOpen, onRename, onFork, onArchive, drag, flat = false, t }) {
			...
			const sessionMenuItems = [
				...
				},
				{
					id: "fork",
					label: t("menu.fork"),
					icon: (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconBranchOutline16, {})
				},
				{
					id: "archive",
					label: t("menu.archiveSession"),
					icon: (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconArchiveOutline20, { size: 16 })
				}
			];
			return (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.HoverCard, {
				anchor: (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						!row.blank && (0, react_jsx_runtime.jsx)("span", {
							className: Rows_module_css_default.rowActions,
							children: (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.Menu, {
								open: menuOpen,
								onClose: () => {
									setMenuOpen(false);
								},
		...
		//#endregion
		//#region \0dsh-css:deepseek-harness/packages/client/ui-workspace/src/client/WorkspacePicker.module.css.mjs
		const css$1 = ".b5KM_q_modalAction{min-width:72px}.b5KM_q_modalError,.b5KM_q_menuStatus{margin-top:8px;font-size:12px;line-height:18px}.b5KM_q_modalError{color:var(--dsw-alias-state-error-primary)}.b5KM_q_menuStatus{color:var(--dsw-alias-label-secondary)}";
		const tagId$1 = "@xharness/dsh-client-ui-workspace/WorkspacePicker.module.css";
		...
		var WorkspacePicker_module_css_default = {
			"menuStatus": "b5KM_q_menuStatus",
			"modalAction": "b5KM_q_modalAction",
			"modalError": "b5KM_q_modalError"
		};
		//#endregion
		...
		*/
		function WorkspacePickFlow({ t, open, anchorRef, useWorkspaces, createWorkspace, useDirectoryFlow, renderDirectoryFlow, onPick, onClose, addOnly = false, side = "bottom", selectedId }) {
			...
			const addEntries = flowAvailable ? [{
				...
				icon: (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconPlusOutline16, { size: 16 }),
				disabled: flowBusy
			}] : [];
			...
			const items = pinAdd ? workspaces.map((workspace) => ({
				...
				icon: (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconFolderClose16, { size: 16 }),
				disabled: flowBusy
			})) : addEntries;
			...
			return (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
				...
				(0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.Modal, {
					open: errorOpen,
					onClose: closeModal,
					closeLabel: t("close"),
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:deepseek-harness/packages/client/ui-workspace/src/client/WorkspaceBrowser.module.css.mjs
		const css = ".w3qmIq_root{--dsh-session-list-edge-inset:var(--dsh-sidebar-inline-padding);--dsh-session-list-scrollbar-width:8px;--dsh-session-list-scrollbar-offset:2px;box-sizing:border-box;min-height:0;padding-right:var(--dsh-session-list-edge-inset);flex-direction:column;flex:1;display:flex}.w3qmIq_root.w3qmIq_rail{padding-right:0}.w3qmIq_iconButton{cursor:pointer;width:28px;height:28px;color:var(--dsw-alias-label-secondary);background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.w3qmIq_iconButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.w3qmIq_sectionHeader{box-sizing:border-box;height:36px;color:var(--dsw-alias-label-tertiary);border-radius:12px;flex:none;justify-content:flex-end;align-items:center;gap:4px;margin-bottom:4px;padding-left:4px;display:flex;overflow:hidden}.w3qmIq_root:not(.w3qmIq_rail) .w3qmIq_sectionHeader{margin-top:2px;margin-right:-4px}.w3qmIq_sectionLabel{white-space:nowrap;opacity:1;visibility:visible;min-width:0;max-width:45%;transition:max-width .18s var(--ds-ease-in-out), margin-right .18s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out), transform .18s var(--ds-ease-in-out), visibility 0s linear;flex:none;line-height:20px;overflow:hidden}.w3qmIq_sectionLabelHidden{opacity:0;visibility:hidden;max-width:0;margin-right:-4px;transition-delay:0s,0s,0s,0s,.18s;transform:translate(-4px)}.w3qmIq_searchSlot{box-sizing:border-box;min-width:0;max-width:28px;transition:max-width .18s var(--ds-ease-in-out), padding-left .18s var(--ds-ease-in-out);flex:1;align-items:center;margin-left:auto;padding-left:0;display:flex}.w3qmIq_searchSlotExpanded{max-width:100%;padding-left:0}.w3qmIq_headerActions{opacity:1;visibility:visible;max-width:60px;transition:max-width .18s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out), transform .18s var(--ds-ease-in-out), visibility 0s linear;flex:none;align-items:center;gap:4px;display:flex;overflow:hidden}.w3qmIq_headerActionsHidden{opacity:0;visibility:hidden;pointer-events:none;max-width:0;transition-delay:0s,0s,0s,.18s;transform:translate(4px)}.w3qmIq_search{box-sizing:border-box;cursor:text;width:100%;height:28px;color:var(--dsw-alias-label-secondary);transition:width .18s var(--ds-ease-in-out), padding .18s var(--ds-ease-in-out), border-color .18s var(--ds-ease-in-out), background-color .18s var(--ds-ease-in-out);background:0 0;border:none;border-radius:50%;flex:none;align-items:center;gap:0;margin:0;padding:0;display:flex;overflow:hidden}.w3qmIq_searchExpanded{border:1px solid var(--dsw-alias-border-l2);width:calc(100% + 4px);height:30px;color:var(--dsw-alias-label-caption);background:0 0;border-radius:10px;margin-inline:-2px;padding:0 4px 0 0}.w3qmIq_searchButton{cursor:pointer;width:28px;height:28px;color:inherit;background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.w3qmIq_searchExpanded .w3qmIq_searchButton{width:28px;height:30px}.w3qmIq_searchButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.w3qmIq_searchExpanded .w3qmIq_searchButton:hover{background:0 0}.w3qmIq_searchInput{opacity:0;pointer-events:none;width:0;min-width:0;color:var(--dsw-alias-label-primary);transition:opacity .12s var(--ds-ease-in-out);background:0 0;border:none;outline:none;flex:1;font-size:13px;line-height:18px}.w3qmIq_searchExpanded .w3qmIq_searchInput{opacity:1;pointer-events:auto;margin-left:-2px}.w3qmIq_searchInput::placeholder{color:var(--dsw-alias-label-tertiary)}.w3qmIq_clearButton{cursor:pointer;width:24px;height:24px;color:var(--dsw-alias-label-secondary);background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.w3qmIq_clearButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.w3qmIq_rail .w3qmIq_sectionHeader{justify-content:flex-start;gap:0;margin-bottom:12px;padding-left:0}.w3qmIq_rail .w3qmIq_headerActions{max-width:none}.w3qmIq_rail .w3qmIq_iconButton{width:36px;height:36px;color:var(--dsw-alias-label-primary)}.w3qmIq_rail .w3qmIq_search{background:0 0;border-color:#0000;gap:0;width:36px;height:36px;margin:0 0 12px;padding:0}.w3qmIq_rail .w3qmIq_searchButton{width:36px;height:36px;color:var(--dsw-alias-label-primary)}.w3qmIq_rail .w3qmIq_searchButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.w3qmIq_listArea{min-height:0;margin-left:-4px;margin-right:calc(-1 * var(--dsh-session-list-edge-inset));flex-direction:column;flex:1;padding-left:4px;display:flex;overflow:visible}.w3qmIq_rail .w3qmIq_listArea{margin-left:0;margin-right:0;padding-left:0}.w3qmIq_treeBody{flex-direction:column;flex:1;min-height:0;display:flex;position:relative}.w3qmIq_fade{left:0;right:var(--dsh-session-list-edge-inset);background:linear-gradient(to bottom, transparent, var(--dsw-specific-sidebar-fill));pointer-events:none;height:24px;position:absolute;bottom:0}.w3qmIq_wide{animation:w3qmIq_wide-in .2s var(--ds-ease-in-out)}@keyframes w3qmIq_wide-in{0%{opacity:0}}.w3qmIq_list{min-height:0;margin-left:-4px;margin-right:var(--dsh-session-list-scrollbar-offset);padding-left:4px;padding-right:calc(var(--dsh-session-list-edge-inset) - var(--dsh-session-list-scrollbar-width) - var(--dsh-session-list-scrollbar-offset));scrollbar-gutter:stable;flex:1;padding-bottom:16px;overflow-y:auto}.w3qmIq_flatList>*+*,.w3qmIq_searchTree>[role=treeitem]+[role=treeitem],.w3qmIq_groupSection>*+*{margin-top:2px}.w3qmIq_searchStatus,.w3qmIq_searchWarning{color:var(--dsw-alias-label-tertiary);padding:10px 12px;font-size:12px;line-height:18px}.w3qmIq_searchWarning{color:var(--dsw-alias-label-secondary)}.w3qmIq_groupSection{position:relative}.w3qmIq_groupSection+.w3qmIq_groupSection{margin-top:4px}.w3qmIq_listTopDropIndicator,.w3qmIq_workspaceDropBefore:before,.w3qmIq_workspaceDropAfter:after{content:\"\";z-index:1;background:linear-gradient(55deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 0 / 5px 7px no-repeat, linear-gradient(125deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 5px / 5px 7px no-repeat, linear-gradient(var(--dsw-alias-state-business-primary) 0 0) 4px 5px / calc(100% - 4px) 2px no-repeat;pointer-events:none;height:12px;position:absolute;left:0;right:0}.w3qmIq_listTopDropIndicator{top:-8px;left:0;right:var(--dsh-session-list-edge-inset)}.w3qmIq_listTopDropActive>.w3qmIq_workspaceDropBefore:first-child:before{display:none}.w3qmIq_workspaceDropBefore:before{top:-8px}.w3qmIq_workspaceDropAfter:after{bottom:-8px}.w3qmIq_sessionOverflowButton{cursor:pointer;text-align:left;width:100%;height:28px;color:var(--dsw-alias-label-tertiary);background:0 0;border:none;border-radius:8px;padding:0 12px 0 28px;font-size:12px}.w3qmIq_groupSection>.w3qmIq_sessionOverflowButton{margin-top:0}.w3qmIq_sessionOverflowButton:hover{color:var(--dsw-alias-label-secondary);background:0 0}.w3qmIq_empty{color:var(--dsw-alias-label-tertiary);padding:16px 12px;font-size:13px}.w3qmIq_renameInput{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);width:100%;height:44px;color:var(--dsw-alias-label-primary);background:0 0;border-radius:22px;outline:none;padding:7px 14px;font-size:14px;font-weight:400;line-height:22px}.w3qmIq_renameInput:disabled{color:var(--dsw-alias-label-dimmed)}.w3qmIq_renameError{color:var(--dsw-alias-state-error-primary);margin-top:8px;font-size:12px;line-height:18px}.w3qmIq_deleteAction:not(:disabled){color:var(--dsw-alias-state-error-primary)}.w3qmIq_deleteStatus{color:var(--dsw-alias-label-secondary);font-size:12px;line-height:18px}@media (prefers-reduced-motion:reduce){.w3qmIq_wide{animation:none}.w3qmIq_search,.w3qmIq_sectionLabel,.w3qmIq_searchSlot,.w3qmIq_searchInput,.w3qmIq_headerActions{transition:none}}";
		const tagId = "@xharness/dsh-client-ui-workspace/WorkspaceBrowser.module.css";
		...
		*/
		...
		function ViewOptionsMenu({ groupBy, orderBy, onGroupPick, onOrderPick, t }) {
			...
			return (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.Menu, {
				open,
				onClose: () => {
					setOpen(false);
				},
				...
				dense: true,
				portal: true,
				anchor: (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.Tooltip, {
					...
					children: (0, react_jsx_runtime.jsx)("button", {
						...
						children: (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconPersonalizationOutline16, {})
					})
				})
			});
		}
		...
		function WorkspaceBrowser({ wide, expandSidebar, useSessions, useWorkspaces, useStore, actions, startSession, open, renameSession, forkSession, renameWorkspace, deleteWorkspace, insertWorkspaceBefore, archiveSession, insertSessionBefore, createWorkspace, searchSessions, searchResultLimit, useDirectoryFlow, useHostDescription, renderSlot, t }) {
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
						...
						children: [
									...
									children: [
										(0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.Tooltip, {
											...
											children: (0, react_jsx_runtime.jsx)("button", {
												...
												children: (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconSearchOutline16, { size: searchExpanded ? 11 : 14 })
											})
										}),
										...
										searchExpanded && (0, react_jsx_runtime.jsx)("button", {
											...
											children: (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconCloseFill14, {})
										})
									]
								})
							}),
							(0, react_jsx_runtime.jsxs)("div", {
								...
								children: [wide && (0, react_jsx_runtime.jsx)(ViewOptionsMenu, {
									...
									t
								}), directoryFlowAvailable && (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.Tooltip, {
					...
					(0, react_jsx_runtime.jsxs)(_xharness_dsh_client_ui_primitives.Modal, {
