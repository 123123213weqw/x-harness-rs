window.__ModuleLoader__.load({
	...
	factory: (require) => {
// XHARNESS SETTINGS SAVE FEEDBACK
...
function xhSettingsSaveFeedback(namespace, failed) {
  ...
  (modal || document.body).append(notice);
		...
		*/
		var SettingsSchemaService = class extends _xharness_cordis.Service {
		...
		var SettingsScopeController = class {
			...
			*/
			constructor(api, spec, mirror, persistence, schema) {
				...
				this.schema = schema;
				this.store = (0, _xharness_dsh_client_runtime_client.createSnapshotStore)({
		...
		*/
		var SettingsScopeBinder = class extends _xharness_cordis.Service {
			mirror;
			schema;
			/**
