	...
	factory: (require) => {
			...
			return (0, react_jsx_runtime.jsxs)("li", {
				...
				children: [(0, react_jsx_runtime.jsxs)("button", {
					...
					children: [
						...
						(0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconChevronDownOutline14, { className: clsx(PluginCard_module_css_default.chevron, open && PluginCard_module_css_default.chevronOpen) })
					]
		...
		*/
		var CardForm = class {
			...
			*/
			bind(project) {
				const store = (0, _xharness_dsh_client_runtime_client.createSnapshotStore)(project());
				this.listeners.add(() => {
					store.set(project());
				});
				return store;
				...
				getSnapshot: () => {
					...
					if (version !== tabsVersion || revision !== tabsRevision) {
						...
						tabs = ctx.slots.entries("settings.plugins.tab").map((entry) => ({
							...
							label: (0, _xharness_dsh_client_ui_slots.resolveSlotLabel)(entry.options.label) ?? ""
