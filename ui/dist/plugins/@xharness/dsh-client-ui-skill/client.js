		...
		*  Keep aligned with ui-tool's models/tool-call-model.ts `resultText`. */
		...
		function leadingFor(state) {
			switch (state) {
				...
				default: return (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconSkillOutline16, { size: 14 });
			}
		}
		...
		function disclosureLeading(state, open, expandable) {
			if (open) return (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconChevronDownOutline14, { className: SkillRow_module_css_default.chevron });
			...
			return (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [(0, react_jsx_runtime.jsx)("span", {
				...
				children: icon
			}), (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconChevronDownOutline14, { className: `${SkillRow_module_css_default.chevron} ${SkillRow_module_css_default.chevronHover}` })] });
		}
