window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:deepseek-harness/packages/session-query/session-log-export/src/client/HeaderAction.module.css.mjs
		const css = ".SPhQuq_sessionLogButton{border:1px solid var(--dsw-alias-border-l2);min-width:111px;height:32px;color:var(--dsw-alias-label-primary);font-family:var(--dsw-font-family);cursor:pointer;background:0 0;border-radius:18px;justify-content:center;align-items:center;gap:4px;padding:6px 12px;font-size:13px;font-weight:400;line-height:20px;display:inline-flex}.SPhQuq_sessionLogButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.SPhQuq_sessionLogButton:disabled{color:var(--dsw-alias-label-dimmed);cursor:wait}.SPhQuq_sessionLogButton span,.SPhQuq_sessionLogButton svg{flex:none}.SPhQuq_sessionLogButton span{white-space:nowrap}";
		const tagId = "@xharness/dsh-session-log-export/HeaderAction.module.css";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "@xharness/dsh-session-log-export";
			tag.dataset.pluginCss = tagId;
			tag.textContent = css;
			document.head.appendChild(tag);
		}
		var HeaderAction_module_css_default = { "sessionLogButton": "SPhQuq_sessionLogButton" };
		//#endregion
		...
		*/
		function SessionLogDownloadHeaderAction(props) {
			...
			return (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [(0, react_jsx_runtime.jsxs)("button", {
				...
				children: [(0, react_jsx_runtime.jsx)("span", { children: "Session log" }), (0, react_jsx_runtime.jsx)(_xharness_dsh_client_ui_primitives.IconDownloadOutline16, { size: 12 })]
