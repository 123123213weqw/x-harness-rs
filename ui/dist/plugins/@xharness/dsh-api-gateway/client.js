window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		var ClientRemoteService = class extends _xharness_cordis.Service {
			ownerCtx;
		...
		var RemoteNamespaceService = class RemoteNamespaceService extends _xharness_cordis.Service {
			invokeRemote;
