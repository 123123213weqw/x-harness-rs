...
统一发布流水线覆盖 macOS ARM64/Intel、Linux x64 AppImage、Windows x64；四平台
签名包先聚合为完整 Draft，原生升级验收与正式门禁通过后才更新稳定通道。Windows 0.2.5
已经发布；Mac/Linux 正式通道仍需 Apple 凭据和发布验收，不能把 CI 构件当成已经上线。
